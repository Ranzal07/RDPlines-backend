...
#simplify
@app.route('/https://rdplines-backend2.onrender.com/api/simplify', methods = ['POST'])
def trigger():
    return_val = {}
...
@app.route('/https://rdplines-backend2.onrender.com/download')
def download():
    # send the newly created csv file to the react client
    return send_file(simplified_file, as_attachment=True)

#members api route
@app.route("/https://rdplines-backend2.onrender.com/members")
